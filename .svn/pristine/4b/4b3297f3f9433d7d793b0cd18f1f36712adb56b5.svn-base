...
<div id="headerTitle"><span style="font-size: 0.8em">欢迎使用</span><br/><span>流量兑换平台</span></div>
		...
		<div class="content">
			<h2 class="failColor center">兑换码验证失败！</h2>
			<p class="failColor">很抱歉，您输入的${retMsg}，请重新输入正确的兑换码。如有疑问，请致电客服400-055-2797。</p>
			<p><a href="../codeCheck/toCodeCheck.do">点击这里</a>返回至首页</p>
		</div>
		<footer>
